...
export default function Landing() {
  return (
    <div className="min-h-screen bg-background">
      <section className="px-4 sm:px-6 pt-24 pb-16 sm:pt-32 sm:pb-24">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-secondary text-base sm:text-lg leading-relaxed max-w-md mb-10">
            A coding platform built for developers who take practice seriously.
            No fluff. No gamification. Just problems and progress.
          </p>
      ...
      <section className="px-4 sm:px-6 py-12 border-y border-border">
      ...
      <section className="px-4 sm:px-6 py-16 border-y border-border">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="nothing-card overflow-hidden">
            ...
            <div className="flex h-72 sm:h-80">
              ...
              <div className="flex-1 hidden sm:flex flex-col bg-[#1a1a1a]">
                <div className="flex items-center justify-between px-4 h-8 border-b border-border/30">
                  <span className="text-xs font-medium text-white/70">
                    CODE
                  </span>
                  <span className="text-[0.625rem] font-mono uppercase tracking-widest text-white/40">
                    JAVASCRIPT
                  </span>
                </div>
                <div className="flex-1 p-4 overflow-hidden">
                  <pre className="font-mono text-[0.6875rem] leading-[1.8]">
                    <code>
                      ...
                      <span className="text-[#60a5fa]">has</span>
                      ...
                      <span className="text-white/60">(needed), i];</span>
                      {"\n"}
                      {"    "}
                      <span className="text-white/60">seen.</span>
                      <span className="text-[#60a5fa]">set</span>
                      <span className="text-white/60">(nums[i], i);</span>
                      {"\n"}
                      {"  "}
                      <span className="text-white/60">{"}"}</span>
                      {"\n"}
                ...
                <div className="flex items-center justify-between px-4 h-9 border-t border-border/30">
                  <div className="flex gap-2">
                    <span className="text-[0.6875rem] px-2 py-1 rounded bg-white/10 text-white/60 font-medium">
                      RUN
                    </span>
                    <span className="text-[0.6875rem] px-3 py-1 rounded bg-white text-black font-medium">
                      SUBMIT
                    </span>
                  </div>
